...
public class PositionControl {
	...
	public String gotoAddPosition(Model model) {
		...
		return "/WEB-INF/quyu/addposition.jsp";
	}
	...
	public String selectPosition(Model model) {
		...
		String str = "/WEB-INF/quyu/positionList.jsp";
		try {
			//所有区域带到页面上
			List<Quyu>  quyuList = QuyuServiceInf.selectQuyu();
			model.addAttribute("quyuList",quyuList );
	...
	public String selectPositionByid(int position_id, Model model) {
		String str = "/WEB-INF/quyu/updateposition.jsp";
		try {
			//根据职称id,查找职称信息
...
System.out.println("123");
	...
	@RequestMapping("selectDepartmentByAreaid")
	@ResponseBody
	public  String  selectDepartmentByAreaid(int area_id, HttpServletResponse  response) {

		//String str = "/WEB-INF/quyu/departmentList.jsp";
		String   jsonStr = "";
		try {
			
			 List<Department> departmentList = positionServiceInf.selectDepartmentByAreaid(area_id);
			 jsonStr =  JSON.toJSONString(departmentList);
