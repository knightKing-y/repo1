...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td height="31" class="right_tittle">您的位置：<a
			href="<%=basePath%>employeeControl/selectEmployee.action?page=1">员工管理</a>
			&gt;&gt;添加员工
		</td>
	</tr>
</table>

<form action="<%=basePath%>employeeControl/addEmployee.action?page=1"
	...
	<tr>
			<td width="10" height="50" align="left">手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机:<input type="text"
				...
				maxlength="11" onblur="checkemployee_tel()" />
